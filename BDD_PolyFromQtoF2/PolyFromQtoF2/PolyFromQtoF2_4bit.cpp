...
int main (int argc, char* argv[]) 
{
    ...
    // cout<<get<string>(variable2_list[0])<<endl;
    // cout<<get<string>(variable2_list[1])<<endl;
    // cout<<get<string>(variable2_list[2])<<endl;
    // cout<<get<string>(variable2_list[3])<<endl;
...
*/
    ...
    // for(int mono_iter=0;mono_iter<8;mono_iter++)
    // {
...
bool isTermEqual(term_t eq_term_p,term_t eq_term_g,monomial_t variable2_list)
{
    ...
    for(int list_num=0;list_num<8;list_num++)
    {
