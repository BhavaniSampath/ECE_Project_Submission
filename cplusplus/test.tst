...
{ rank = same; "CONST NODES";
{ node [shape = box]; "0x409";
}
}
"  s0  " -> "0x486" [style = solid];
"  s1  " -> "0x488" [style = solid];
"  s2  " -> "0x48a" [style = solid];
"  c3  " -> "0x48b" [style = solid];
"0x48a" -> "0x489";
"0x48a" -> "0x489" [style = dotted];
"0x48b" -> "0x410";
"0x48b" -> "0x489" [style = dashed];
"0x410" -> "0x409";
"0x410" -> "0x409" [style = dotted];
"0x489" -> "0x442";
"0x489" -> "0x487" [style = dashed];
"0x488" -> "0x487";
"0x488" -> "0x487" [style = dotted];
"0x442" -> "0x409";
"0x442" -> "0x409" [style = dotted];
"0x487" -> "0x461";
"0x487" -> "0x485" [style = dashed];
"0x486" -> "0x485";
"0x486" -> "0x485" [style = dotted];
"0x461" -> "0x409";
"0x461" -> "0x409" [style = dotted];
"0x485" -> "0x409";
"0x485" -> "0x409" [style = dotted];
"0x409" [label = "1"];
}
...
Number of cache deletions: 2288
