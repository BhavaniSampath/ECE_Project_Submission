...
void dd_man::R_M_LVL(travex functex)
{
	...
	do
	{
		...
		while(last == FALSE)
		{
			...
			cout<<"variable:"<<PI<<endl<<"label:"<<lab<<endl<<"table ip:"<<Act_Prime[maxi_i]<<endl;
			...
			maxi_i++;
			cout<<"Inside reading input line"<<endl;
		}
		//while(last == FALSE);
	...
	cout<<"Finished reading input line"<<endl;
	...
	do
	{
		...
		cout<<"variable:"<<PO<<endl<<"label:"<<lab<<endl;
	}
	while(last == FALSE);
	...
	maxt_i = 0;
	cout<<"Finished reading output:"<<endl;
	...
	cout<<"Finished reading wires:"<<endl;
			...
			usint   searchmax = name_limit)
{
	...
	last		= FALSE;
	char j  ='0';
	cout<<"name_limit:"<<searchmax<<endl;
	...
	cout<<"wordbefore:"<<j<<endl;
	//cout<<"wordbefore:"<<gl_name[i--]<<endl;
	//fu1(I3,j,name_limit) cout<<"wordbefore:"<<gl_name[I3]<<endl;
	fu1(I3,i,name_limit) gl_name[I3] = ' ';
	//fu1(I3,j,name_limit) cout<<"wordafter:"<<gl_name[I3]<<endl;
...
names* dd_man::Make_Prime(uchar type)
{
	...
	// ----------------------------------
	cout<<"Inside construction of hash node:"<<endl<<"number of PI"<<OKFDD_P_I<<'\t'<<"number of PO"<<OKFDD_P_O<<'\t'<<"limit:"<<pi_limit<<endl;
	if (type == TF)
	{
		if ( T_F > pi_limit-2)
                {
...
/* ========================================================================= */
// Function:    dd_man::OKFDD_Get_outVariable // Rtrn root of lab with giv.name //
/* ========================================================================= */
utnode* dd_man::OKFDD_Get_outVariable(     char*   name)
{
	names*  nhelp;
	usint   lab;
	...
	{
	   nhelp = Make_Prime(PO);
	   OKFDD_PI_DTL_Table[nhelp->label_i] = D_posD;
	   Support_complete();
	}
...
/* ========================================================================= */
// Function:    dd_man::OKFDD_1_PC // Returns no. of 1 paths in OKFDD with no blif    //
/* ========================================================================= */
ulint dd_man::OKFDD_1_PC_noblif(utnode*	root,
			 char*	  dumpfilename)
{
	if (dumpfilename != NULL)
	{
	     ...
	     ulint elements = OKFDD_1_PC_noblif_mult(root_table,TRUE,dumpfilename);
             delete[] root_table; return elements;
	}
	else return OKFDD_1_PC_Slave(root);
};
...
/* ========================================================================= */
// Function:    dd_man::OKFDD_1_PC_noblif_mult	// Returns no. of 1 paths in OKFDDs  //
/* ========================================================================= */
ulint dd_man::OKFDD_1_PC_noblif_mult(  utnode**	root_table,
				uchar	   Shared,
				char*	   dumpfilename)
{
	usint   loop		  = 0;
...
//      for (var = von; var <= bis; var++)
	...
	for (var = von; var <= bis; var++)
	{
	   ...
	   // suche n�chstes Level f�r Tausch
	   // -------------------------------
	   switch (art)
	   {
	      case 'l':  // suche max. Level
