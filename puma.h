...
/**/    ulint	   	ctlookuphitno;
  ...
  // msoeken (adding labels)
	...
	// --------------------------------------------------------------------
	utnode*
	OKFDD_Get_outVariable(     char*	 Primary_Name);
	...
	// --------------------------------------------------------------------
	// Returns number of 1-paths in given OKFDD no blif
	// --------------------------------------------------------------------
	ulint
	OKFDD_1_PC_noblif      (       utnode*	 Root,
				char*	 Dumpfilename = NULL     	);
	...
	// --------------------------------------------------------------------
	ulint
	OKFDD_1_PC_noblif_mult (       utnode** Root_Table_NT,
				uchar	 Unshared_Shared,
				char*	 Dumpfilename = NULL     	);
